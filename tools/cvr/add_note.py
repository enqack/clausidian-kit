...
Usage:
  python3 tools/cvr/add_note.py --type cursed-knowledge --title "Never do X" [--run-id <run-id>] [--body "..."]
  python3 tools/cvr/add_note.py --type deep-thought --title "On linting" [--run-id <run-id>] [--body "..."]
"""
